...
-(void)defaultSetting {
    ...
    _vcnNickNameArray = @[@"小燕", @"小宇", @"小研", @"凯瑟琳",@"小琪",@"小峰",@"小新",@"小坤"];
    _vcnIdentiferArray = @[@"xiaoyan",@"xiaoyu",@"vixy",@"Catherine",@"vixq",@"vixf",@"vixx",@"vixk"];
}
...
+(NSString*)engineTypeAuto {
    return @"auto";
}

+(NSString*)engineTypeCloud{
    return @"cloud";
}

+(NSString*)engineTypeLocal {
    return @"local";
}
