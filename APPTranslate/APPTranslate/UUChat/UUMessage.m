...
- (void)setWithDict:(NSDictionary *)dict{
    ...
    self.belowBtnStrContent = dict[@"translatedStr"];
    self.upBtnLanguage = dict[@"upLanguage"];
    self.upBtnAccent = dict[@"upAccent"];
    self.belowBtnLanguage = dict[@"belowLanguage"];
    self.belowBtnAccent = dict[@"belowAccent"];
