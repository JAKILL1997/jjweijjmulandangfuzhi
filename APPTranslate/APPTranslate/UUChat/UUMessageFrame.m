...
- (void)setMessage:(UUMessage *)message{
    ...
    finalString = [NSString stringWithFormat:@"%@\r\r%@",_message.strContent,_message.belowBtnStrContent];
    //根据种类分
    CGSize contentSize;
    switch (_message.type) {
        case UUMessageTypeText:
            contentSize = [finalString sizeWithFont:ChatContentFont  constrainedToSize:CGSizeMake(ChatContentW, CGFLOAT_MAX) lineBreakMode:NSLineBreakByWordWrapping];
            break;
    ...
    //上面button的frame
    CGSize upBtnSize = [message.strContent sizeWithFont:ChatContentFont  constrainedToSize:CGSizeMake(ChatContentW, CGFLOAT_MAX) lineBreakMode:NSLineBreakByWordWrapping];
    
    //下面button的framw
    CGSize belowBtnSize = [message.belowBtnStrContent sizeWithFont:ChatContentFont constrainedToSize:CGSizeMake(ChatContentW, CGFLOAT_MAX) lineBreakMode:NSLineBreakByWordWrapping];
    ...
    _upBtnContentF = CGRectMake(contentX, contentY, contentSize.width + ChatContentLeft + ChatContentRight, upBtnSize.height + ChatContentTop + ChatContentBottom);
    
    _belowBtnContentF = CGRectMake(contentX, contentY + upBtnSize.height + ChatContentTop, contentSize.width + ChatContentLeft + ChatContentRight, belowBtnSize.height + ChatContentTop + ChatContentBottom);
