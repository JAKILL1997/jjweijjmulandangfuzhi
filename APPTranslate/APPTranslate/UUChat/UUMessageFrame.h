...
@property (nonatomic, assign, readonly) CGRect contentF;//两端文字总体的frame

@property (nonatomic, assign, readonly) CGRect upBtnContentF;//上面文字的frame
@property (nonatomic, assign, readonly) CGRect belowBtnContentF;//下面文字的frame
